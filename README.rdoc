...
An event driven (Fluentd)[http://fluentd.org/] input plugin for sending logs through UDP. The plugin uses (Coo.io)[http://coolio.github.io/] similarly to other parts in Fluentd.
